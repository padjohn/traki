...
| `30` | **Ganymede** | But it made me remember something\. | ➡️ `31` \[Ganymede\] |
...
| `67` | **Ganymede** | And it just so happens that there's this village, nearby\. | ➡️ `68` \[Ganymede: You can't tell me that the option wasn't on the ta\.\.\.\] |
