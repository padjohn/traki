...
| `181` | **Pandora** | Really? | ➡️ `182` \[Pandora: You aren't mad?\] |
...
| `246` | **invalid** |  | ➡️ `231` \[Eurydice: Thank you, Sophia\.\] |
...
| `129` | **invalid** |  | ➡️ `134` \[Eurydice: Cleo, have you met our neighbours?\] |
...
| `326` | **Pandora** |  | ➡️ `273` \[Pandora: Where are we?\] |
