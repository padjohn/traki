...
| :------- | :------ | :------- | :------------ |
| `0` | **Ganymede** |  | → `1` Ganymede<br>→ `593` Ganymede: Debug SH<br>→ `596` Ganymede |
| `1` | **Ganymede** |  | → `3` \-\-\-\-: Yo\.<br>→ `593` Ganymede: Debug SH |
| `3` | **----** | Yo\. | → `4` Ganymede |
| `4` | **Ganymede** |  | → `5` \-\-\-\-: Hello? |
| `5` | **----** | Hello? | → `6` Ganymede |
| `6` | **Ganymede** |  | → `7` \-\-\-\-: Come on\.\.\. |
| `7` | **----** | Come on\.\.\. | → `8` \-\-\-\-: Don't be like that\. |
| `8` | **----** | Don't be like that\. | → `597` Ganymede<br>→ `9` Ganymede |
...
| `19` | **Ganymede** | Excuse me? | → `20` Player: Ganymede\.<br>→ `21` Player: You heard me\.<br>→ `22` Player: ∅ |
...
| `154` | **Ganymede** | Pretty please? | → `155` Player: Timotej\.<br>→ `156` Player: Trojan Boy\.<br>→ `157` Player: What the fuck are you on about? |
...
| `33` | **Ganymede** | Can you do it one more time? | → `20` Player: Ganymede\.<br>→ `22` Player: ∅ |
| `22` | **Player** | ∅ | → `35` Ganymede |
| `35` | **Ganymede** |  | → `36` Ganymede: Hey\! |
| `36` | **Ganymede** | Hey\! | → `37` Ganymede |
| `37` | **Ganymede** |  | → `38` Ganymede |
| `38` | **Ganymede** |  | → `39` Player: Sorry\.<br>→ `41` Player: ∅ |
...
| `143` | **Ganymede** | I'll tell you something\. | → `20` Player: Ganymede\.<br>→ `21` Player: You heard me\. |
...
| `50` | **Ganymede** |  | → `48` Player: Sorry\.<br>→ `49` Player: ∅ |
...
| `58` | **Ganymede** |  | → `56` Player: Sorry\.<br>→ `57` Player: ∅ |
...
| `63` | **Ganymede** |  | → `61` Player: Sorry\.<br>→ `62` Player: ∅ |
...
| `70` | **Ganymede** | Knowing that there's someone out there\. | → `72` Player: ∅<br>→ `73` Player: Sorry\. |
...
| `98` | **Ganymede** |  | → `96` Player: Sorry\.<br>→ `97` Player: ∅ |
...
| `116` | **Ganymede** |  | → `114` Player: Sorry\.<br>→ `115` Player: ∅ |
...
| `593` | **Ganymede** | Debug SH | → `442` Ganymede: At least I made it through in one p\-<br>→ `524` \-\-\-\- |
...
| `425` | **Ganymede** | But it's been a long time coming\. | → `426` Ganymede<br>→ `442` Ganymede: At least I made it through in one p\- |
