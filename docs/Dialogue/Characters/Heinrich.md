...
| :------- | :------ | :------- | :------------ |
| `0` | **Pandora** |  | → `1` Heinrich: Yeah?<br>→ `1` Heinrich: Yeah?<br>→ `42` \*\*Atlas\*\*: That's a nice uniform you have on display over the\.\.\.<br>→ `75` Heinrich: We're done\. |
| `1` | **Heinrich** | Yeah? | → `167` Pandora: Thank you so much for helping out\!<br>→ `186` Heinrich: What do you want?<br>→ `192` Heinrich: Weren't you on your way out?<br>→ `277` Pandora<br>→ `209` Pandora<br>→ `211` Pandora<br>→ `213` Pandora<br>→ `216` Pandora<br>→ `176` Pandora: Hey\.<br>→ `224` Pandora: Hey\!<br>→ `193` Pandora: What am I doing here?<br>→ `194` Heinrich: How many hints do you need?<br>→ `279` Pandora: I should talk to Dorothy\.<br>→ `2` Heinrich: What do you want? |
| `1` | **Pandora** |  | → `167` Pandora: Thank you so much for helping out\!<br>→ `186` Heinrich: What do you want?<br>→ `192` Heinrich: Weren't you on your way out?<br>→ `277` Pandora<br>→ `209` Pandora<br>→ `211` Pandora<br>→ `213` Pandora<br>→ `216` Pandora<br>→ `176` Pandora: Hey\.<br>→ `224` Pandora: Hey\!<br>→ `193` Pandora: What am I doing here?<br>→ `194` Heinrich: How many hints do you need?<br>→ `279` Pandora: I should talk to Dorothy\.<br>→ `2` Heinrich: What do you want? |
