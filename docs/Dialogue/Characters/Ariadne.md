...
| `5` | **Ariadne** | Onions, garlic and potatoes\. | ➡️ `6` \[Ariadne: Would you mind getting those from the pantry?\] |
| `6` | **Ariadne** | Would you mind getting those from the pantry? | ➡️ `7` \[Ganymede: Sure\!\] |
| `7` | **Ganymede** | Sure\! | ➡️ `8` \[Ganymede: I'll be right back\!\] |
| `8` | **Ganymede** | I'll be right back\! | ➡️ `9` \[none: none\] |
| `9` | **none** | none | ➡️ `10` \[Ariadne: Don't worry about the dishes, darling\.\] |
| `10` | **Ariadne** | Don't worry about the dishes, darling\. | ➡️ `11` \[Ariadne: We'll take care of them\.\] |
| `11` | **Ariadne** | We'll take care of them\. | End |
| `12` | **Ariadne** | The pantry is right over there\. | End |
| `13` | **Ariadne** | I'll be right there\. | End |
| `14` | **Ariadne** | Brunch should be ready in a minute\. | ➡️ `15` \[Ganymede: Yeah, about that\.\.\.\] |
| `15` | **Ganymede** | Yeah, about that\.\.\. | ➡️ `16` \[Ganymede: I'm terribly sorry, but I just remembered that I u\.\.\.\] |
| `16` | **Ganymede** | I'm terribly sorry, but I just remembered that I urgently need to be somewhere\. | ➡️ `17` \[Ariadne: Really?\] |
| `17` | **Ariadne** | Really? | ➡️ `18` \[Ganymede: Yeah\.\.\.\] |
| `18` | **Ganymede** | Yeah\.\.\. | ➡️ `19` \[Ganymede: Wish it could wait, but there's nothing I can do, \.\.\.\] |
| `19` | **Ganymede** | Wish it could wait, but there's nothing I can do, I'm afraid\. | ➡️ `20` \[Ariadne: That's a shame\.\] |
| `20` | **Ariadne** | That's a shame\. | ➡️ `21` \[Ariadne: I feel very embarrassed putting you to work like t\.\.\.\] |
| `21` | **Ariadne** | I feel very embarrassed putting you to work like that and not even giving something in return\. | ➡️ `22` \[Ariadne: How about you take some of that stew with you?\] |
| `22` | **Ariadne** | How about you take some of that stew with you? | ➡️ `23` \[Ganymede: I could never accept that\.\] |
| `23` | **Ganymede** | I could never accept that\. | ➡️ `24` \[Ariadne: Please, I insist\!\] |
| `24` | **Ariadne** | Please, I insist\! | ➡️ `25` \[Ganymede: Okay\.\.\.\] |
| `25` | **Ganymede** | Okay\.\.\. | ➡️ `26` \[Ganymede: But only a tiny bit\.\] |
| `26` | **Ganymede** | But only a tiny bit\. | ➡️ `27` \[Ariadne: There you go\.\] |
| `27` | **Ariadne** | There you go\. | ➡️ `28` \[Ganymede: Hold on\!\] |
| `28` | **Ganymede** | Hold on\! | ➡️ `29` \[Ganymede: This is way too much\!\] |
| `29` | **Ganymede** | This is way too much\! | ➡️ `30` \[Ariadne: Not at all\!\] |
