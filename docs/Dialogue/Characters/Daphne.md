...
| :------- | :------ | :------- | :------------ |
| `0` | **invalid** |  | → `83` Ganymede<br>→ `1` Daphne: You're not wandering off, are you?<br>→ `3` Daphne: You really think that's going to work?<br>→ `52` \*\*Daphne\*\*: The prefecture is in Sigmund Plaza, just south of \.\.\. |
...
| `83` | **Ganymede** |  | → `149` Pandora: Are you okay?<br>→ `247` Daphne: Remember to enjoy yourself\.<br>→ `103` Daphne: Hey Lorna\.<br>→ `248` Daphne: Don't be shy\.<br>→ `261` Daphne: The world's a village, huh?<br>→ `376` Daphne: Right behind you\.<br>→ `333` Daphne: Victory lap, hm?<br>→ `335` Daphne: Atlas?<br>→ `265` Daphne: Sorry\.<br>→ `342` Daphne: Eyes ahead\. |
...
| `303` | **Daphne** | No luck at the Checkpoint? | → `257` Pandora<br>→ `249` Pandora: No luck so far\. |
